...
/// @title User Proxy
contract YfgUserProxy is Authorizable {
        ...
        returns (uint256)
    {
        ...
        uint256 ptMinted = _mint(_expiration, _position, _donationAddress); // YFG - added donation address
        // This sanity check ensure that as much was minted as was transferred
        require(ptMinted == _amount, "deposit and mint mismatch");
        return (ptMinted);
    }
    ...
    function _mint(
        ...
        IYfgTranche tranche = _deriveTranche(
            address(_position),
            _expiration,
            _donationAddress
        ); // YFG - added donation address
    ...
    function _deriveTranche(
        ...
        uint256 _expiration,
        address _donationAddress
    ) internal view virtual returns (IYfgTranche) {
        ...
        return IYfgTranche(address(uint160(uint256(addressBytes))));
    }
